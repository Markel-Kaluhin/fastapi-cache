[![Python application](https://github.com/Markel-Kaluhin/fastapi-cache/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/Markel-Kaluhin/fastapi-cache/actions/workflows/build.yml)
